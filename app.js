...
createClientBtn.addEventListener("click", async () => {
  ...
  try {
    // Nota: createUserWithEmailAndPassword cambierà l'utente loggato; in un'app reale si userebbe l'Admin SDK
    ...
    // Dopo aver creato il cliente, l'admin viene automaticamente loggato come quel cliente.
    // Per tornare all'account admin, puoi effettuare il logout e rientrare.
  } catch (error) {
