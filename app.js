...
// ADMIN: Crea nuovo cliente (salva l'email nel documento)
createClientBtn.addEventListener("click", async () => {
  ...
  try {
    ...
    await setDoc(doc(db, "users", uid), { email: newEmail, role: "cliente" });
...
// ADMIN: Modifica Ritiro (modifica data e quantità)
